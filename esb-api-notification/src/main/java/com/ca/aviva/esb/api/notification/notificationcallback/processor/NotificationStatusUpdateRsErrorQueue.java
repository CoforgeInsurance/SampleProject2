...
public class NotificationStatusUpdateRsErrorQueue implements Processor {

	public static final Logger log = LoggerFactory.getLogger(NotificationStatusUpdateRsErrorQueue.class);

	@Override
	public void process(Exchange exchange) throws SOAPServiceException {
		log.info(NotificationConstants.LOGTAG + " in the  processor of NotificationStatusUpdateRsErrorQueue");
		...
		log.info(NotificationConstants.LOGTAG + " At the end of processor of NotificationStatusUpdateRsErrorQueue");
	}
}
